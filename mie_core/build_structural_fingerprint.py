...
Data-first guard is executed before output is persisted.
"""
...
def main():
 ...
 d=json.loads(Path(a.input).read_text()); assert_no_manual_success_weights(d)
 g=d.get('global',d); r=d.get('recurrence',{}); s=d.get('salience',{}); ir=d.get('internal_recurrence',{})
 fp={
  'schema':'TMT_STRUCTURAL_FINGERPRINT_v1.1','song_id':d.get('song_object_id',d.get('song_id')),
  ...
  'epistemic_guard':{'policy':'DATA_FIRST','mode':'DESCRIPTIVE','manual_success_weights':'REJECTED'},

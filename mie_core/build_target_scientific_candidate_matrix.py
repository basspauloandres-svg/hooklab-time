...
genre/style, YouTube reach and Spotify reach gates pass. Social-network reach and
melodic-reference validation remain explicit pending gates before scientific promotion.
"""
...
def main():
 ...
 summary={'schema':'HOOKLAB_TARGET_SCIENTIFIC_CANDIDATE_MATRIX_v1.1','cohort_key':reg['cohort_key'],'rows':len(rows),'target_cohort_candidates':sum(r['target_candidate_status']=='TARGET_COHORT_CANDIDATE' for r in rows),'youtube_floor':yf,'spotify_floor':sf,'remaining_gates':['social_network_reach','melodic_reference_validation'],'scientific_promotion':False}

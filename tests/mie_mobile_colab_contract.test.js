...
assert(source.includes("REF = 'codex/mie-continuity-alignment-v0.3.4'"));
...
assert(source.includes("MIE_RECOGNITION_MHT_v0_3_4.wav"));
assert(source.includes("MIE_RECOGNITION_v0_3_4.json"));
assert(source.includes("A · AUDIO DE ENTRADA"));
assert(source.includes("B · BASELINE MIE v0.3.3"));
assert(source.includes("C · CANDIDATO MIE v0.3.4: RECUPERACIÓN DE HUECOS + RELOJ M/H COMPARTIDO"));
assert(source.includes("D · RECONSTRUCCIÓN FINAL v0.3.4"));
assert(source.includes("melody_gap_recovery"));
assert(!Object.prototype.hasOwnProperty.call(notebook.metadata,'accelerator'));

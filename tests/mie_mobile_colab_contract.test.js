...
assert(source.includes("REF = 'codex/mie-tf-plane-v0.3.2'"));
...
assert(source.includes("MIE_RECOGNITION_MHT_v0_3_2.wav"));
assert(source.includes("MIE_RECOGNITION_v0_3_2.json"));
assert(source.includes("A · AUDIO DE ENTRADA"));
assert(source.includes("B · MIE v0.3.1 SIN CONTINUIDAD DE PLANO"));
assert(source.includes("C · MIE v0.3.2 CON CONTINUIDAD DE PLANO"));
assert(source.includes("D · RECONSTRUCCIÓN FINAL v0.3.2"));
